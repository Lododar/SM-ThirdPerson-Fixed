...
{
	name = "[TF2] Thirdperson FIXED",
	author = "DarthNinja / Lododar",
	description = "Allows players to use thirdperson without having to enable client sv_cheats (NO helloserverplugintogglethirdpresononmeplease)",
	version = PLUGIN_VERSION,
	url = "https://github.com/Lododar/SM-ThirdPerson-Fixed"
};
